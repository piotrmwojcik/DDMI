...
class DDPM(nn.Module):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        print('!!!!')
        print(model_out.min().item())
        print(model_out.max().item())
    ...
    def get_mixing_component(self, noisy, t):
        return extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, noisy.shape) * noisy